...
function processResponse(response, { statusCode = 200, body = true, bearer = false } = {}) {
  console.log('processResponse Status Code:', response.statusCode);
  console.log('processResponse Headers:', JSON.stringify(response.headers));
  console.log('processResponse Body:', JSON.stringify(response.body));
